...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.fromNamespaceAndPath(QuincyPlateMod.MOD_ID, name), block);
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(QuincyPlateMod.MOD_ID, name), new BlockItem(block, new Item.Properties()));
        return block;
    }

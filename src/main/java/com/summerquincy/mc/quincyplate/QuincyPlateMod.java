...
public class QuincyPlateMod implements ModInitializer {
	public static final String MOD_ID = "quincyplate";
	@SuppressWarnings("unused")
	public static final Logger LOGGER = LoggerFactory.getLogger(MOD_ID);
	public static final GameRules.Key<GameRules.IntegerValue> RULE_MAX_PLATE_SIZE = GameRuleRegistry.register("quincyPlateMaxSize", GameRules.Category.MISC, GameRuleFactory.createIntRule(-1));

...
public class ModRecipeGen extends RecipeProvider {
    ...
    private void generateDyedPlateRecipes(ItemLike result, TagKey<Item> plateShapeTag, String shapeName, ItemLike dye, @NotNull RecipeOutput pWriter) {
        var resultResourceLocation = BuiltInRegistries.ITEM.getKey(result.asItem());

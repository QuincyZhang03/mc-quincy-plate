...
public class ModBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<RoundPlateBlockEntity>> ROUND_PLATE_BLOCK_ENTITY =
            BLOCKENTITIES.register("plate_be", () ->
                    BlockEntityType.Builder.of(RoundPlateBlockEntity::new, ModBlocks.WHITE_PLATE.get()).build(null));
